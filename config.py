...
# Login mode: 'manual' (default) waits for you to login + press Enter, 'auto' uses USERNAME/PASSWORD
LOGIN_MODE = "manual"
...
TM_FORMS = {
    ...
    "TM-02": {
        ...
        "duplicate_column": None  # NO CHECK
    },
    "TM-05": {
